...
const UpdateBooks = () => {
    ...
    const handleRatingChange = (newRating) => {
      ...
      const handleSubmit = (e) =>{
        ...
        axios.put(`/books/${data._id}`,product)
        .then(res=>{
    ...
    return (
        <div className=" w-[85vw] mx-auto my-32">
            <h2 className=' text-center underline text-3xl font-semibold my-10'>Update Book</h2>
            

<form onSubmit={handleSubmit}>
  <div className="relative z-0 w-full mb-6 group">
      <input defaultValue={data?.productImg} type="text" name="img" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div className="relative z-0 w-full mb-6 group">
      <input defaultValue={data?.productName} type="text" name="name" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
      <label  className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Product Name</label>
  </div>
  <div className="relative z-0 w-full mb-6 group">
      <input defaultValue={data?.productQuantity} type="number" name="quantity" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div className="relative z-0 w-full mb-6 group">
      <input defaultValue={data?.authorName} type="text" name="author" id="floating_repeat_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div className="grid md:grid-cols-2 md:gap-6">
    <div className="relative z-0 w-full mb-6 group">
        ...
        <select defaultValue={data?.catCode} required name="cat" id="" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer">
    ...
    <div className="relative z-0 w-full mb-6 group">
        <input defaultValue={data?.productDes} type="text" name="des" id="floating_last_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div>
      ...
      <Rating
        ...
        activeColor="#0000FF"
        isHalf={false}
        value={data?.rating} // You can set the initial value here
      />
    </div>
  </div>
